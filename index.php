...
?>
    ...
    <div class="container-fluid">
        <div class="navbar-header"><a href="index.php" class="navbar-brand navbar-link">Aavas.com</a>
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown"><a data-toggle="dropdown" aria-expanded="true" href="#" class="dropdown-toggle">SIGN IN<span class="caret"></span></a>
                    <ul role="menu" class="dropdown-menu">
                    <li>
                        <form method="POST">
...
<br>
    ...
    <input type="email" class="form-control signin" id="email1" placeholder= "Email" name="email" required><br><br>
      <input type="password" class="form-control signinpass" id="pwd" placeholder="Password" name="password" required>
...
<div class="row">
    ...
    <div class="col-sm-6 pass"><a href="#" class="pass">Forget Password?</a>
    </div>
</div>
    <button type="submit" class="btn btn-default signin" name="signin">Sign In</button>
                            <div class="row signinlast">
                                <div class="col-sm-12 signindont">
                                    <a href="#" class="dont">Don’t have a Zocalo account?</a>
                                </div>
                ...
                <li class="dropdown"><a data-toggle="dropdown" aria-expanded="false" href="#" class="dropdown-toggle">SIGN UP<span class="caret"></span></a>
                    <ul role="menu" class="dropdown-menu signup">
                      <li>
                          <form method="POST">
<div class="row">
...
<div class="form-group signup">
    <input type="text" class="form-control fn" id="fn" placeholder="Full Name" name="fullname" required><br>
    <input type="email" class="form-control email" id="email" placeholder="Email" name="email" required><br>
    <input type="password" class="form-control pwd" id="pwd" placeholder="Password" name="password" required><br>
    <input type="password" class="form-control cpwd" id="cpwd" placeholder="Confirm Password" name="confirmpassword" required><br>
    <input type="text" class="form-control cno" id="cno" placeholder="Contact Number" name="contactnumber" required>
</div>
                                   

    <button type="submit" class="btn btn-default signup" name="signup">Sign Up</button>
</form>
                     </li>
                    </ul>
                </li>
				<li class="dropdown"><a data-toggle="dropdown" aria-expanded="true" href="#" class="dropdown-toggle">POST PROPERTY<span class="caret"></span></a>
                    <ul role="menu" class="dropdown-menu">
                    <li>
                        <form method="POST">
                            ...
                            <div class="row 1st">
                                <div class="col-sm-12 1st">
                                    <div class="col-sm-3 picbox" style="cursor-pointer;" data-link="http://www.coho.in/flats-in-delhi/girls-coho-1149">
                                        <div class="col-sm-12 img"><img src="assets/img/14525216653259.jpg" class="img" alt="Apartment - in Chandigarh" title="Apartment - in Chandigarh
										
										/*<?php
									include "db_con.php";

									$cek = "SELECT profilepic FROM usersignup";
								...
								?>*/" 
										...
										class="img" alt="Apartment - in Chandigarh" title="Apartment - in Chandigarh"></div>
                                    ...
                                    <div class="col-sm-3 picbox" style="cursor-pointer;" data-link="http://www.coho.in/flats-in-delhi/girls-coho-1149">
                                        <div class="col-sm-12 img"><img src="	assets/img/14504341836907.jpg" class="img" alt="Apartment - in Chandigarh" title="Apartment - in Chandigarh
                                        /*<?php
									include "db_con.php";
